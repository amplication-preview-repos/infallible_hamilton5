...
export class TaskControllerBase {
  ...
  @common.Get("/tasks/pending")
  @swagger.ApiOkResponse({
    type: TaskPendingResponse,
  })
  ...
  async GetPendingTask(
    @common.Body()
    body: string
  ): Promise<TaskPendingResponse> {
    return this.service.GetPendingTask(body);
  }

  @common.Post("/tasks/{id}/error")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async ReportLoginError(
    @common.Body()
    body: TaskErrorInput
  ): Promise<string> {
    return this.service.ReportLoginError(body);
  }

  @common.Post("/tasks/{id}/requestOtp")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async RequestOtpVerification(
    ...
    return this.service.RequestOtpVerification(body);
  }

  @common.Post("/tasks")
  @swagger.ApiOkResponse({
    type: TaskLoginResponse,
  })
  @swagger.ApiNotFoundResponse({
    type: errors.NotFoundException,
  })
  ...
  async SubmitLoginTask(
    @common.Body()
    body: TaskLoginInput
  ): Promise<TaskLoginResponse> {
    return this.service.SubmitLoginTask(body);
  }

  @common.Post("/tasks/{id}/otp")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async SubmitOtpCode(
    ...
    return this.service.SubmitOtpCode(body);
  }
}
